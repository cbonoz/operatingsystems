		...
		unsigned int cmd, unsigned long arg)
{
	...
	if (cmd == OSPRDIOCACQUIRE) {
		...
		{
			if (wait_event_interruptible(d->blockq, my_ticket==d->ticket_head && !d->writelockset)) 
			{
				r= -ERESTARTSYS;
			}
			else 
